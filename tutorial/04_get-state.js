...
console.info(`Output: store_1 state after initialization: {}
...
console.info(`Output: reducer_2 was called with state {} and action { type: '@@redux/INIT' }`);

console.log('store_2 state after initialization:', store_2.getState());

console.info(`Output: store_2 state after initialization: {}
